...
>(
  (
    ...
    if (isMobile) {
      return (
        <>
          ...
          <div
            className={cn(
              "fixed inset-y-0 z-50 h-full w-[--sidebar-width-mobile] bg-sidebar text-sidebar-foreground shadow-lg transition-transform duration-200 ease-in-out",
    ...
    return (
      <div
        className={cn(
          "relative h-full w-[--sidebar-width] bg-sidebar text-sidebar-foreground transition-all duration-200 ease-in-out",
